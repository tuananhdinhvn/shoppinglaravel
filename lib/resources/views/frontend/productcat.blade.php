...
<head>
    ...
    <title>
        Tất cả sản phẩm &ndash; Beauty farm
    </title>
            ...
            <section id="insCollection" class="pageTemplate">
                ...
                <div class="insBreadcrumb ">
                    <div class="banner-breadcrumb" style="background: url(//theme.hstatic.net/1000271724/1000376256/14/breacrumb_banner.jpg?v=88) no-repeat center center;">
                        <h2>{{ $procat_item->procat_ten }}</h2>
                        <ul>
                            <li><a href="{{ asset('/') }}" target="_self">Trang chủ</a></li>

                            <li><a href="{{ asset('product') }}" target="_self">Sản phẩm</a></li>

                            <li class="active"><span>{{ $procat_item->procat_ten }}</span></li>
                                    ...
                                    <div class="moduleGroup banner">
                                        ...
                                        <div class="moduleContent">
                                            <div class="imageHover">
                                                ...
                                                </a>            <img src="{{ asset('public/upload/template/'.$product_admin->product_advertise) }}" alt="Products">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
