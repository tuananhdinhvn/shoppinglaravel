                ...
                <div style="padding: 20px 10px 0 10px;" class="form-panel">
                    ...
                    <form class="form-horizontal style-form" method="post">
                        <div class="form-group hidden">
                            <label class="col-sm-2 col-sm-2 control-label">Người viết:</label>
                            <div class="col-sm-10">
                                <input type="text" name="sp_nguoiviet" class="form-control" value="{{ Auth::user()->username }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                    <textarea class="editmce" name="sp_noidung" id="" style="width:100%;" rows="30"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea name="sp_mota" id="" style="width:100%;" rows="7"></textarea>
                            </div>
                        </div>
