        ...
        <div class="row mt">
            ...
            <div class="col-lg-12">
                <div class="form-panel">
                    ...
                    <h4 class="mb">Thêm danh mục sản phẩm</h4>
                    @include('error.note')
                    <form class="form-horizontal style-form" method="post">
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">Tên danh mục: </label>
                            <div class="col-sm-10">
                                <input type="text" required name="procat_ten" value="{{ old('procat_ten') }}" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">Mô tả: </label>
                            <div class="col-sm-10">
                                <input type="text" required name="procat_mota" class="form-control">
                            </div>
                        </div>
