<header class="header black-bg">
    ...
    <a href="{{ asset('admin/dashboard') }}" class="logo"><b>ADMIN<span>{{ $active_sidebar_admin[1] }}</span></b></a>
    <!--logo end-->
    ...
    <div class="top-menu">
        <ul class="nav pull-right top-menu">
            <li><a class="logout" href="{{ asset('/') }}" target="_blank"><i class="fa fa-home" style="padding-right:10px;"></i>Xem website</a></li>
        </ul>
    </div>
</header>